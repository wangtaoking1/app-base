...
// formatInfo contains all the errors information.
...
// Verbs:
//
//	%s  - Returns the user-safe errors string mapped to the errors code or
//	  ┊   the errors message if none is specified.
//	%v      Alias for %s
//
// Flags:
//
...
//	+      Output full errors stack details, useful for debugging
//
// Examples:
//

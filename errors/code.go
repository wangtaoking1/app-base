...
var unknownCoder = defaultCoder{
	...
	"http://github.com/wangtaoking1/app-base/errors/README.md",
}
...
func Register(coder Coder) {
	if coder.Code() == 0 {
		panic("code `0` is reserved by `github.com/wangtaoking1/app-base/errors` as unknownCode error code")
	}
...
func MustRegister(coder Coder) {
	if coder.Code() == 0 {
		panic("code '0' is reserved by 'github.com/wangtaoking1/app-base/errors' as ErrUnknown error code")
	}
